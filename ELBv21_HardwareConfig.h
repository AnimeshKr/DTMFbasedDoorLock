...
#define  PWM4 _LATD1
/****************DTMF**************/
// Sch : (DTMF1 = RB14 = CN32); (DTMF2 = RB15 = CN12); (DTMF3 = RG6 = CN8); (DTMF4 = RG8 = CN10)
...
#define DTMF1_DIR _TRISB14
#define DTMF2_DIR _TRISB15
#define DTMF3_DIR _TRISG6
#define DTMF4_DIR _TRISG8

#define Enable_DTMF1Int()     (CNPD3bits.CN32PDE = 1, CNEN3bits.CN32IE = 1, IEC1bits.CNIE = 1)
#define Enable_DTMF2Int()     (CNPD1bits.CN12PDE = 1, CNEN1bits.CN12IE = 1, IEC1bits.CNIE = 1)
#define Enable_DTMF3Int()     (CNPD1bits.CN8PDE = 1, CNEN1bits.CN8IE = 1, IEC1bits.CNIE = 1)
#define Enable_DTMF4Int()     (CNPD1bits.CN10PDE = 1, CNEN1bits.CN10IE = 1, IEC1bits.CNIE = 1)
#define Enable_DTMF1234Int()   (Enable_DTMF1Int(), Enable_DTMF2Int(), Enable_DTMF3Int(), Enable_DTMF4Int())

#define Disable_DTMF1Int()     (CNPD3bits.CN32PDE = 0, CNEN3bits.CN32IE = 0, IEC1bits.CNIE = 0)
#define Disable_DTMF2Int()     (CNPD1bits.CN12PDE = 0, CNEN1bits.CN12IE = 0, IEC1bits.CNIE = 0)
#define Disable_DTMF3Int()     (CNPD1bits.CN8PDE = 0, CNEN1bits.CN8IE = 0, IEC1bits.CNIE = 0)
#define Disable_DTMF4Int()     (CNPD1bits.CN10PDE = 0, CNEN1bits.CN10IE = 0, IEC1bits.CNIE = 0)
#define Disable_DTMF1234Int()   (Disable_DTMF1Int(), Disable_DTMF2Int(), Disable_DTMF3Int(), Disable_DTMF4Int())
